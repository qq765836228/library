					...
					<ul class="nav nav-list">
						...
						<li class="active">
							...
							<ul class="submenu">
								...
								<li class="active">
									<a href="${pageContext.request.contextPath }/Category/findAll/1">
										<i class="icon-double-angle-right"></i>
										查 询 所 有 分 类
									</a>
								</li>
				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs" >
						...
						<ul class="breadcrumb" style="line-height:41px;">
							...
							<li class="active">显 示 所 有 分 类</li>
						</ul><!-- .breadcrumb -->
					</div>
					...
					<div class="page-content">
						<div class="row">
								<div class="col-xs-12">
										<h3 class="header smaller lighter blue">分 类</h3>
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<c:forEach items="${CVO.list }" var="c">
													...
													<tr>
														<td>总条数：${CVO.totalNumber }</td>
														<td>每页显示条数：${CVO.number }</td>
														<td>总页数：${CVO.totalPage }\当前页：${CVO.currentPage+1 }</td>
														<td>
