				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li class="active">
							<a href="#" class="dropdown-toggle">
								<i class="icon-tag"></i>
								<span class="menu-text">图 书 分 类 管 理 </span>
							...
							<ul class="submenu">
								<li class="active">
									<a href="${pageContext.request.contextPath }/admin/jsp/addCategorys.jsp">
										<i class="icon-double-angle-right"></i>
										新 增 分 类
									</a>
								</li>
								<li>
									<a href="${pageContext.request.contextPath }/admin/jsp/Categorys.jsp">
										<i class="icon-double-angle-right"></i>
										查 询 所 有 分 类
									</a>
								</li>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="${pageContext.request.contextPath }/Category/addCategory" method="post">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 分 类 名 称 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1"  class="col-xs-10 col-sm-5" name="category_name"/>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-ISBN">所 属 书 架 </label>

										<div class="col-sm-9">
											<input  type="text" class="col-xs-6 col-sm-3" id="form-input-ISBN" name="category_case"/>
