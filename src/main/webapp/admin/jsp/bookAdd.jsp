...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>图书添加</title>
		<meta name="keywords" content="图书添加" />
		<meta name="description" content="图书添加" />
				...
				<div class="sidebar" id="sidebar">
					<ul class="nav nav-list">
						...
						<li  class="active">
							...
							<ul class="submenu">
								<li class="active"><a href="${pageContext.request.contextPath }/Book/bookAddUI" class="dropdown-toggle">添 加 图 书 信 息 </a></li>
						...
						<div class="row">
							...
							<form class="form-horizontal">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="book_name"  class="col-xs-10 col-sm-5"  name="book_name"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input  type="text" class="col-xs-6 col-sm-3" id="book_isbn" name="book_isbn"/>
											<span class="help-inline col-xs-12 col-sm-7">
												<label class="middle">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input class="input-sm" type="text" id="book_autor"  name="book_autor"/>											
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="clearfix">
												<input class="col-xs-3" type="text" id="book_pubhouse"  name="book_pubhouse"/>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input  type="text" class="col-xs-2 col-sm-1" id="book_page" name="book_page"/>
											<span class="help-inline col-xs-12 col-sm-7">
												<label class="middle">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea rows="6" cols="50" id="others" name="others"></textarea>
										</div>
									</div>
