...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>更改服务时间</title>
		<meta name="keywords" content="更改服务时间" />
		<meta name="description" content="更改服务时间" />
				...
				<div class="sidebar" id="sidebar">
					<ul class="nav nav-list">
						...
						<li  class="active">
							...
							<ul class="submenu">
								<li class="active"><a href="${pageContext.request.contextPath }/Admin/editNoticeUI/1">更改服务时间</a></li>
