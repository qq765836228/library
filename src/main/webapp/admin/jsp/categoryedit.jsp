...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>分类修改</title>
		<meta name="keywords" content="分类修改" />
		<meta name="description" content="分类修改" />
	...
	<script type="text/javascript">
		function check(){
			...
			var Ocategory="${category.category_name }";			
		...
		function checkForm(){
			...
			var category_case=$("#Ccase").val();
			var c=$(".error").text();
			if(category_name == null || category_name =="" ){
				return false;
				
			}
			if(category_case == "" || category_case == null){
				return false;
			}
			if(c != ""){
				return false;
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">							
							<form class="form-horizontal" action="${pageContext.request.contextPath }/Category/editCategory/${page}" onsubmit="return checkForm()" method="post" >
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="Cname" name="category_name" value="${category.category_name }" class="col-xs-6 col-sm-3" onblur="check()" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input  type="text" class="col-xs-6 col-sm-3" id="Ccase" value="${category.category_case }" name="category_case" />
											<span class="help-inline col-xs-12 col-sm-7">
												<label class="middle">
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<button id="add" class="btn btn-info" type="submit" value="">
												<i class="icon-ok bigger-110"></i>
												修改
											</button>

											&nbsp; &nbsp; &nbsp;
											<button id="ret"  class="btn" type="reset" value="">
