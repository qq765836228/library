...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>添加公告</title>
		<meta name="keywords" content="添加公告" />
		<meta name="description" content="添加公告" />
					...
					<ul class="nav nav-list">
						...
						<li  class="active">
							...
							<ul class="submenu">
								...
								<li  class="active"><a href="${pageContext.request.contextPath }/admin/jsp/addNotice.jsp">发布公告</a></li>
